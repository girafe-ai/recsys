from bert4rec_modules_and_configs.templates import set_template
...
parser.add_argument('--prepared_data_path', type=str, default='prepared_dataset/dataset_for_bert4rec.pickle')
